...
export default function SGPAPage() {
  ...
  // =========================
  return (
    <div className="min-h-screen bg-transparent p-4 md:p-6 space-y-6">
              ...
              <tr key={sub.course_code} className="border-b">
                ...
                <td>
                  <select
                    ...
                    className="border px-2 py-1 rounded-md outline-none transition-all"
                    style={{ backgroundColor: "rgba(10, 10, 10, 0.4)", color: "var(--text)", borderColor: "rgba(255, 255, 255, 0.2)" }}
                  >
      ...
      {editMode && (
        <Card className="flex flex-col md:flex-row gap-3">
          <input
            ...
            className="border px-3 py-2 rounded-md w-full outline-none placeholder-gray-400"
            style={{ backgroundColor: "rgba(10, 10, 10, 0.4)", color: "var(--text)", borderColor: "rgba(255, 255, 255, 0.2)" }}
          />
          ...
          <input
            ...
            className="border px-3 py-2 rounded-md w-full md:w-32 outline-none"
            style={{ backgroundColor: "rgba(10, 10, 10, 0.4)", color: "var(--text)", borderColor: "rgba(255, 255, 255, 0.2)" }}
          />

          <button
            onClick={handleAddSubject}
            className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg transition active:scale-95 font-medium"
      ...
      <Card className="flex justify-between items-center py-4">
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg transition active:scale-95 shadow-sm font-medium"
            style={{ backgroundColor: "var(--accent)", color: "var(--accent-fg)" }}
          >
            <Pencil size={16} />
            {editMode ? "Done" : "Edit"}
          ...
          <button
            onClick={handleReset}
            className="flex items-center gap-2 px-4 py-2 rounded-lg transition active:scale-95 shadow-sm"
