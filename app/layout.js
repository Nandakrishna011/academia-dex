  ...
  return (
    <html lang="en">
      <head>
        ...
        />
            <meta name="google-site-verification" content="rs_9ujewlsKHcxwqrsIXQAcZxG2Ku6YMMmArdi1PcTs" />
      </head>
      ...
      <body>
        <AuthProvider>
          ...
          {/* Fixed Theme Selector - Top Right */}
          <div className="fixed top-4 right-4 z-40 hidden md:block w-40">
            <ThemeSelector />
          </div>
